...
# df = df.filter(['id', 'x', 'y', 'z', 'freq', 'amp'])
# print (df)
#
# #print out data
# values = df.values
...
# model.add(LSTM(512, return_sequences=True))  # returns a sequence of vectors of dimension 32
# model.add(LSTM(512))
# model.add(Dense(1))
...
# print ('saved')
#
# # body = count = 1000, minimum value = [0.9831034], maximum value = [4.8013]
# # head = count = 1000, minimum value = [1.378901], maximum value = [4.8652506]
# # RH = count = 1000, minimum value = [-0.88319325], maximum value = [0.9546343]
# # LH = count = 1000, minimum value = [-1.7333173], maximum value = [-0.70207745]
#
